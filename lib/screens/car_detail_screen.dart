...
class _CarDetailScreenState extends State<CarDetailScreen> {
  ...
  Future<void> _loadReviews() async {
    final reviews = await BookingService().fetchCarReviews(
      widget.listing.id,
      limit: 100,
    );
    if (mounted) {
                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      CarImageCarousel(
                        images: widget.listing.images,
                        onTap: (index) => _openFullScreenImage(index),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Wrap(
                                  ...
                                  children: [
                                    _metaItem(
                                      Icons.star_rounded,
                                      '${widget.listing.averageRating.toStringAsFixed(1)} (${_reviews.length} reviews)',
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                'PKR ${widget.listing.pricePerDay.toInt()}',
                                style: GoogleFonts.outfit(
                                  fontSize: 26,
                                  fontWeight: FontWeight.bold,
                                  color: themeColor,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Precise location shared after booking',
    ...
    return Container(
      ...
      child: Column(
        children: [
          _pricingRow(
            'Daily Rate',
            'PKR ${widget.listing.pricePerDay.toInt()} x ${_pricingEstimate!.totalDays}',
          ),
          if (_pricingEstimate!.driverFeePerDay > 0)
            _pricingRow(
              'Driver Service',
              'PKR ${_pricingEstimate!.driverFeePerDay.toInt()} / day',
            ),
          const Divider(height: 32),
          _pricingRow(
            'Total Rental',
            'PKR ${_pricingEstimate!.netCostToRenter.toInt()}',
            isBold: true,
          ),
          _pricingRow(
            'Security Deposit',
            'PKR ${_pricingEstimate!.depositAtPickup.toInt()}',
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Pay PKR ${_pricingEstimate!.depositAtPickup.toInt()} cash at handover.',
                    style: GoogleFonts.inter(
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
      ...
      child: Column(
        children: [
          _stepRow(
            '01',
            'Request Booking',
            'Select dates and send request to host.',
          ),
          _stepRow(
            '02',
            'Host Confirms',
            'Once accepted, meet the host for handover.',
          ),
          _stepRow(
            '03',
            'Security Deposit',
            'Pay deposit in cash and take the keys.',
          ),
          _stepRow(
            '04',
            'Return & Pay',
            'Return the car, pay rent, and get deposit back.',
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: SafeArea(
        child: ElevatedButton(
          ...
          child: Text(
            canBook ? 'Request to Book' : 'Select Trip Dates',
            style: GoogleFonts.outfit(
              fontSize: 18,
              fontWeight: FontWeight.bold,
            ),
...
class _ReviewsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final displayCount =
        (reviews.length > listing.totalReviews)
            ? reviews.length
