...
## Corpus Check
- 122 files · ~218,804 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 912 nodes · 1111 edges · 31 communities detected
...
2. `package:cloud_firestore/cloud_firestore.dart` - 23 edges
3. `GET()` - 22 edges
...
Cohesion: 0.03
Nodes (66): ../booking/booking_detail_screen.dart, package:google_fonts/google_fonts.dart, package:intl/intl.dart, ../../providers/booking_provider.dart, ../renter/my_bookings_screen.dart, request_detail_screen.dart, ../reviews/submit_review_screen.dart, ../trip/pre_trip_inspection_screen.dart (+58 more)
...
Cohesion: 0.04
Nodes (50): chat_screen.dart, core/theme/app_theme.dart, firebase_options.dart, ../models/notification_model.dart, package:provider/provider.dart, ../../providers/auth_provider.dart, ../../providers/chat_provider.dart, screens/home_screen.dart (+42 more)
...
Cohesion: 0.05
Nodes (42): dart:ui, package:geocoding/geocoding.dart, package:geolocator/geolocator.dart, package:google_maps_flutter/google_maps_flutter.dart, ../search_screen.dart, build, CarLocationMapScreen, Scaffold (+34 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (42): booking/booking_summary_screen.dart, car_location_map_screen.dart, ../chat/chat_screen.dart, ../models/review_model.dart, package:url_launcher/url_launcher.dart, reviews/all_reviews_screen.dart, ../../services/booking_service.dart, build (+34 more)
...
Cohesion: 0.06
Nodes (35): ../car_detail_screen.dart, ../models/listing_model.dart, ../providers/listing_provider.dart, ../services/listing_service.dart, ListingProvider, loadAllListings, loadMyListings, AnimatedListingCard (+27 more)
...
Cohesion: 0.06
Nodes (30): main_navigation.dart, package:cached_network_image/cached_network_image.dart, package:flutter/material.dart, build, ListingSuccessScreen, Opacity, Scaffold, SizedBox (+22 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (30): cancellation_screen.dart, ../trip/active_trip_screen.dart, ../trip/cash_settlement_screen.dart, ../trip/post_trip_inspection_screen.dart, _actionBtn, _avatarWidget, BookingDetailScreen, _BookingDetailScreenState (+22 more)
...
Cohesion: 0.08
Nodes (23): build, _buildRenterAvatar, _cashRow, CircleAvatar, _CnicStatusBadge, Container, _detailRow, dispose (+15 more)
...
## Knowledge Gaps
- **679 isolated node(s):** `main`, `package:flutter_test/flutter_test.dart`, `-registerWithRegistry`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `MainActivity` (+674 more)
...
- **Thin community `Community 23`** (4 nodes): `layout.tsx`, `useRoleGuard.ts`, `DashboardLayout()`, `useRoleGuard()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `package:flutter/material.dart` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`?**
  _High betweenness centrality (0.321) - this node is a cross-community bridge._
- **Why does `package:cloud_firestore/cloud_firestore.dart` connect `Community 8` to `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 9`, `Community 10`, `Community 12`, `Community 14`, `Community 17`, `Community 19`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `package:provider/provider.dart` connect `Community 2` to `Community 0`, `Community 1`, `Community 5`, `Community 7`, `Community 10`, `Community 11`, `Community 12`, `Community 14`, `Community 17`, `Community 18`, `Community 19`?**
